...
var newData =
  'https://sheets.googleapis.com/v4/spreadsheets/1v8ufFEjFRTK6PBAs8SIULGZ3TPg0IIyGvDladOSfuFs/values/A1:Y1000?key=AIzaSyCWoBi6aUWf2TDFr7ZHefTta9So4v_aZWA';
...
function initialize() {
  ...
  map = new atlas.Map('myMap', {
    ...
    authOptions: {
      ...
      subscriptionKey: 'tyJrOhZts6R1AqEfXsVPRIt9HBK4yKlaIawPzZEOZEM',
    },
  });
...
function loadStoreData() {
  ...
  fetch(newData)
    ...
    .then(function (text) {
      ...
      var textString = JSON.parse(dataString);
      //Parse the Tab delimited file data into GeoJSON features.
      var features = [];
      //Split the lines of the file.
      var lines = textString.values;
      // //Grab the header row.
      var row = textString.values[0];
